  ...
  return (
    <>
            ...
            <div className="col-6">
              <div className="main-product-details">
                ...
                <div className="border-bottom py-3">
                  ...
                  <a className="review-btn">Write a Review</a>
                </div>
                <div className="py-3">
                  ...
                  <div className="d-flex gap-10 flex-column my-3">
                    ...
                    <p className="product-data">
                      Free ahipping and returns available on all orders! <br/> We ship all US domestic orders within <b>5-10 business days!</b>
                    </p>
                  </div>
      ...
      <Container class1="popular-wrapper py-5 home-wrapper-2">
          <div className="row">
            <div className="col-12">
              <h3 className="section-heading">Our Popoular Products</h3>
            </div>
            <ProductCard />
            <ProductCard />
            <ProductCard />
